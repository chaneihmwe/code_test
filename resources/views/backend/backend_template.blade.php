...
<head>
  ...
  <link href="{{asset('backend_template/css/custom.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{asset('backend_template/csv_format.csv')}}">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>CSV Format Download</span></a>
      </li>
      <!-- Divider -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="{{asset('backend_template/image/admin.png')}}">
              </a>
  ...
  <script src="{{asset('backend_template/js/select2.min.js')}}"></script>
